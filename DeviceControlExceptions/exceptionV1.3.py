...
for target_cid in target_cids:
    try:
        ...
        for policy_name in policy_names:
            ...
            with open(f"existingExceptions/{target_cid}-{policy_name.replace(' ', '_')}-EE.json", "w") as f:
                json.dump({"policy_name": policy_name, "combined_ids": existing_combined_ids}, f, indent=4)
